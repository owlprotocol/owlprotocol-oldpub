...
packages/web3-redux/packages/web3-redux/src/typechain/IERC721Receiver.d.ts:39
...
| Name | Type |
| :------ | :------ |
| `onERC721Received` | (`operator`: `string`, `from`: `string`, `tokenId`: `any`, `data`: `string` \| `number`[]) => `NonPayableTransactionObject`<`string`\> |
...
packages/web3-redux/packages/web3-redux/src/typechain/IERC721Receiver.d.ts:31
...
▸ **clone**(): [`IERC721Receiver`](Abi.IERC721Receiver.md)

#### Returns

[`IERC721Receiver`](Abi.IERC721Receiver.md)

#### Defined in

packages/web3-redux/packages/web3-redux/src/typechain/IERC721Receiver.d.ts:30

___

### constructor

▸ **constructor**(`jsonInterface`, `address?`, `options?`): [`IERC721Receiver`](Abi.IERC721Receiver.md)
...
packages/web3-redux/packages/web3-redux/src/typechain/IERC721Receiver.d.ts:25
