...
packages/web3-redux/packages/web3-redux/src/typechain/IERC1155Receiver.d.ts:52
...
| Name | Type |
| :------ | :------ |
| `onERC1155BatchReceived` | (`operator`: `string`, `from`: `string`, `ids`: `any`[], `values`: `any`[], `data`: `string` \| `number`[]) => `NonPayableTransactionObject`<`string`\> |
| `onERC1155Received` | (`operator`: `string`, `from`: `string`, `id`: `any`, `value`: `any`, `data`: `string` \| `number`[]) => `NonPayableTransactionObject`<`string`\> |
...
packages/web3-redux/packages/web3-redux/src/typechain/IERC1155Receiver.d.ts:31
...
▸ **clone**(): [`IERC1155Receiver`](Abi.IERC1155Receiver.md)

#### Returns

[`IERC1155Receiver`](Abi.IERC1155Receiver.md)

#### Defined in

packages/web3-redux/packages/web3-redux/src/typechain/IERC1155Receiver.d.ts:30

___

### constructor

▸ **constructor**(`jsonInterface`, `address?`, `options?`): [`IERC1155Receiver`](Abi.IERC1155Receiver.md)
...
packages/web3-redux/packages/web3-redux/src/typechain/IERC1155Receiver.d.ts:25
