...
export const useERC721Name = contractCallHookFactory<Web3.IERC721Metadata, 'name'>(
    'name',
    { abi },
    Number.MAX_SAFE_INTEGER,
);

export const useERC721Symbol = contractCallHookFactory<Web3.IERC721Metadata, 'symbol'>(
    'symbol',
    { abi },
    Number.MAX_SAFE_INTEGER,
);

export const useERC721TokenURI = contractCallHookFactory<Web3.IERC721Metadata, 'tokenURI'>(
    'tokenURI',
    { abi: Artifacts.IERC721Metadata.abi },
    Number.MAX_SAFE_INTEGER
);

export const useERC721TotalSupply = contractCallHookFactory<Web3.IERC721Enumerable, 'totalSupply'>(
    'totalSupply',
    { abi: Artifacts.IERC721Enumerable.abi },
    0
);

export const useERC721OwnerOf = contractCallHookFactory<Web3.IERC721, 'ownerOf'>(
    'ownerOf',
    { abi },
    1000,
...
export const useERC721GetApproved = contractCallHookFactory<Web3.IERC721, 'getApproved'>(
    'getApproved',
...
export const useERC721IsApprovedForAll = contractCallHookFactory<Web3.IERC721, 'isApprovedForAll'>(
    'isApprovedForAll',
    { abi: Artifacts.IERC721.abi },
    1000,
